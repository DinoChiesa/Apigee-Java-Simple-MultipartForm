...
public class AdapterHttpServletRequest implements HttpServletRequest {
   ...
   */
  public AdapterHttpServletRequest(final byte[] requestData, final String strContentType) {
   ...
   * Creates a new instance with the given request data and content type.
   */
  public AdapterHttpServletRequest(final InputStream requestData, final long requestLength, final String strContentType) {
  ...
  public int getContentLength() {
    ...
    if ((null == this.m_requestData)) {
      ...
      if ((this.length > Integer.MAX_VALUE)) {
          String b = "Value \'" + this.length  + "\' is too large to be converted to int";
  ...
  public ServletInputStream getInputStream() throws IOException {
    final ServletInputStream sis = new AdapterHttpServletRequest.MyServletInputStream(this.m_requestData, this.readLimit);
    return sis;
  }
